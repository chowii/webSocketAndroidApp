...
class Camera2BasicFragment : Fragment(), View.OnClickListener,
     ...
     */
    private lateinit var textureViewOwn: AutoFitTextureView

    private lateinit var surfaceViewOther: GLSurfaceView
...
//        }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        textureViewOwn = view.findViewById(R.id.texture_own)
        surfaceViewOther = view.findViewById(R.id.texture_other)
        gpuImage.setGLSurfaceView(surfaceViewOther)
    }
    ...
    override fun onResume() {
        ...
        if (textureViewOwn.isAvailable) {
            openCamera(textureViewOwn.width, textureViewOwn.height)
        } else {
            textureViewOwn.surfaceTextureListener = surfaceTextureListener
        }
    }
...
//                previewRequest.
                ...
                if (resources.configuration.orientation == Configuration.ORIENTATION_LANDSCAPE) {
                    textureViewOwn.setAspectRatio(previewSize.width, previewSize.height)
                } else {
                    textureViewOwn.setAspectRatio(previewSize.height, previewSize.width)
                }
    ...
    private fun createCameraPreviewSession() {
        try {
            val texture = textureViewOwn.surfaceTexture
    ...
    private fun configureTransform(viewWidth: Int, viewHeight: Int) {
        ...
        textureViewOwn.setTransform(matrix)
    }
    ...
    private fun captureStillPicture() {
        try {
            ...
            captureSession?.apply {
                stopRepeating()
                abortCaptures()
                Log.d("LOG_TAG---", "Camera2BasicFragment#captureStillPicture-659: ")
...
//                        .show()
    ...
    fun onSocketClosed() {
        Snackbar.make(textureViewOwn, "SocketClosed", Snackbar.LENGTH_INDEFINITE).show()
        isSocketOpen = false
    }
}
